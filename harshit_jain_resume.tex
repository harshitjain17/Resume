...
{\bf Relevant Coursework:} Data Structures \& Algorithms, Artificial Intelligence, \href{https://www.coursera.org/account/accomplishments/verify/JYX5UB5YP4YD}{Supervised Machine Learning}, Advanced Learning Algorithms (Deep Learning), Systems Programming, Operating Systems Design, Theory of Computation, Programming and Computation II: Data Structures, CodePath: (Intermediate + Advanced) Software Engineering, Database Management Systemss
\end{rSection}
...
{\bf Frameworks \& Tools:} TensorFlow, Scikit-Learn, Numpy, Node.js, React.js, RESTful APIs, \LaTeX, Git, Agile (Scrum)\\
