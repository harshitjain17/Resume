...
VIAVI Solutions Inc. \hfill Germantown, MD
 \begin{itemize}[itemsep = -4pt]
     \item Collaborating with the 6-person R\&D team to design and implement a Python-based automated test suite on Linux systems for the EGR $2.0$ (instrument), ensuring comprehensive test coverage and compliance with the SCPI protocol
