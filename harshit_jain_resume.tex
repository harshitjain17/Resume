...
\begin{itemize}[itemsep = -4pt]
    ...
    \item Developed Python frameworks and BigQuery SQL views in GCP for monthly KPI evaluation of aircraft and fleet performance, processing data from 61k+ Delta Airlines flights with O(1) time complexity and sub-10-second execution
