...
\begin{itemize}[itemsep = -4pt]
    \item Leveraged SOTA LLMs like GPT-4, Jurassic2, and Llama2 for chatbot-integrated answer retrieval using the RAG Model
...
\begin{itemize}[itemsep = -4pt]
    ...
    \item \underline{Research:} {\bf Developed a Python library} for the {\href{https://github.com/harshitjain17/Raman-Peak-Fitting-Model/}{Raman Fitting model}}, to perform deconvolution on Raman spectra, and enable interactive preprocessing, effective fitting, and export of data files, {\bf reducing analysis time by 40\%} (tested)
