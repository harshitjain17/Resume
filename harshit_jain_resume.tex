...
{\bf Software Engineer Intern} \textit{[Python, AWS (AI), LangChain, Pinecone, GraphQL, Next.js]} \hfill Aug $2024$ - Dec $2024$\\
...
{\bf Software Engineer Intern} \textit{[Python, AWS (AI), LangChain, Next.js, CI/CD, RESTful APIs]} \hfill Jan $2024$ - May $2024$\\
Materials Research Institute (2DCC-MIP Team) \hfill University Park, PA
\begin{itemize}[itemsep = -4pt]
...
{\bf Software Engineer Co-op} \textit{[Python, C/C++, SCPI Protocol, Testing]} \hfill May $2023$ - Dec $2023$\\
