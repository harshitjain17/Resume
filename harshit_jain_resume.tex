...
\begin{itemize}[itemsep = -4pt]
    \item Developed mdadm tool in $C$ for managing multiple disks in Linux systems
    ...
    \item Added JBOD Networking feature to enable communication with JBOD servers over the network
\end{itemize}
