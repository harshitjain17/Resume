...
\address{Seattle, WA \\
\href{tel:15822039755}{(582) 203-9755} \\
...
{\bf Programming Languages:} Python, Golang (Go), Java, C\#/C/C++, JavaScript/TypeScript, SQL, Shell scripting\\
{\bf Frameworks:} Streamlit, Node.js, React.js, Next.js, LangChain, TensorFlow, GraphQL, RESTful APIs, Git\\
{\bf Softwares:} AWS, GCP, Azure, PostgreSQL, Linux, Kubernetes, Docker, CI/CD (Jenkins, Cloud Build)
...
{\bf Microsoft Coorporation} (Azure Storage Team) [Azure, C\#, Python, SQL/KQL] \hfill Seattle, WA
% \begin{itemize}[itemsep = -4pt]
%     \item
% \end{itemize}

{\bf Software Engineer} \hfill Jan $2025$ - Dec $2025$\\
{\bf Hughes Network Systems, LLC} (Aeronautical Team) [GCP, Golang, Node.js, Python, SQL] \hfill Washington, DC
\begin{itemize}[itemsep = -4pt]
    ...
    \item Built flight reconciliation module (Python, Node.js) on scalable Kubernetes setup; reduced billing discrepancies 99\% fleet-wide
...
{\bf Materials Research Institute} (2DCC-MIP Team) [AWS, Python, Langchain, Pinecone, Next.js] \hfill University Park, PA
\begin{itemize}[itemsep = -4pt]
...
{\bf Hughes Network Systems, LLC} (Aeronautical Team) [GCP, Python, SQL] \hfill Washington, DC
\begin{itemize}[itemsep = -4pt]
...
{\bf Materials Research Institute} (2DCC-MIP Team) [AWS (AI), Python, Langchain, RAG, Next.js] \hfill University Park, PA
\begin{itemize}[itemsep = -4pt]
...
{\bf VIAVI Solutions Inc.} (PNT Team) [Python, C++] \hfill Washington, DC
\begin{itemize}[itemsep = -4pt]
...
{\bf Materials Research Institute} (2DCC-MIP Team) [Python, React.js, SQL] \hfill University Park, PA
\begin{itemize}[itemsep = -4pt]
...
\begin{rSection}{PROJECTS}
    ...
    \textbf{JobAssistAI} - Microsoft Hackathon [\href{https://github.com/harshitjain17/JobAssistAI}{Project Link}] [Azure AI, RAG, Python] \hfill Mar 2025
    \begin{itemize}[itemsep = -4pt]
