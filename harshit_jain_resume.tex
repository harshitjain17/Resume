...
Hughes Network Systems, LLC (Aeronautical Team) [GCP, Golang, Node.js, Python, SQL] \hfill Washington, DC
\begin{itemize}[itemsep = -4pt]
...
Materials Research Institute (2DCC-MIP Team) [AWS, Python, Langchain, Pinecone, Next.js] \hfill University Park, PA
\begin{itemize}[itemsep = -4pt]
...
Hughes Network Systems, LLC (Aeronautical Team) [GCP, Python, SQL] \hfill Washington, DC
\begin{itemize}[itemsep = -4pt]
...
Materials Research Institute (2DCC-MIP Team) [AWS (AI), Python, Langchain, RAG, Next.js] \hfill University Park, PA
\begin{itemize}[itemsep = -4pt]
...
VIAVI Solutions Inc. (PNT Team) [Python, C++] \hfill Washington, DC
\begin{itemize}[itemsep = -4pt]
...
Materials Research Institute (2DCC-MIP Team) [Python, React.js, SQL] \hfill University Park, PA
\begin{itemize}[itemsep = -4pt]
