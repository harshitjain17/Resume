...
\begin{itemize}[itemsep = -4pt]
    ...
    \item Developed Python scripts and BigQuery SQL views for Delta Airlines' in-flight connectivity KPI calculations, processing 61k+ flights' data with reducing time complexity to O(1), and achieving sub-10-second processing times
    \item Created intricate billing system Python scripts for processing and invoicing data for over 720k flights annually
