...
\begin{itemize}[itemsep = -4pt]
    \item Working on the ML-centric development of "MaterialsTube", a video aggregator platform for data-driven material discovery. Leveraging AWS (backend) and integrating ML models for enhanced video metadata and content analysis
...
\begin{itemize}[itemsep = -4pt]
    \item Designed custom malloc, free, realloc; segregated free lists and footer optimization to improved memory management
    \item Achieved a utilization score of $69\%$ and consistent benchmark throughput at $100\%$ across diverse computing environments
\end{itemize}
...
\begin{itemize}[itemsep = -4pt]
    ...
    \item Deployed $10+$ advanced features and functions, including real-time student eligibility checks for book borrowing according to their historic data, calculated pending fines at the end of the log and on a specific day within the log, and more
\end{itemize}
